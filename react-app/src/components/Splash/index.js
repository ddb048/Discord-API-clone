				...
				<div>
					<div className='Splash-title'>
						...
						<p className='subtext'>
							...
							together. A place that makes it easy to talk every day and hang
							out often. Within a safe and accepting space.
						</p>
					...
					<div className='Splash-detail odd'>
						<div className='row'>
							<img className='detail-img' id='splash2' src={splash_2} alt='' />
					...
					<div className='Splash-detail even'>
						<div className='row'>
							<img className='detail-img' id='splash3' src={splash_3} alt='' />
					...
					<div className='Splash-detail odd'>
						<div className='row'>
							<img className='detail-img' id='splash4' src={splash_4} alt='' />
							<div className='description-right'>
